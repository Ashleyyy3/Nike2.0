...
<!--https://www.youtube.com/watch?v=sA6fksYiPK8&t=0s  29:35, logout opt.  -->
...
<h1>You are logged in.</h1>
   <p><a href="logout.php" class="btn1" >Log out</a></p>
   <?php if (isset($_SESSION["user_id"])): ?>
<?php else: ?>
  <!-- <p><a href="login.php">Log in</a> or <a href="signup2.html">Sign up</a></p>-->
<?php endif ?>
